...
class PaymentMethodsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final methods = [
      {'title': 'Apple Pay', 'subtitle': 'Connected', 'icon': Icons.apple, 'isDefault': true},
      {'title': 'Visa ending in 4242', 'subtitle': 'Expires 12/28', 'icon': Icons.credit_card, 'isDefault': false},
      {'title': 'Mastercard ending in 8899', 'subtitle': 'Expires 08/26', 'icon': Icons.credit_card, 'isDefault': false},
    ];
